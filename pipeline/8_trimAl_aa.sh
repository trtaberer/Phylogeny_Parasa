...
OUTPUT=/data/buscophy/results/Trimal/aa_filtered_trimmed
mkdir -p $Output

# STEP 4:
# Run trimal:
trimal -in ${SAMPLE_DIRECTORY}/${SAMPLE_NAME}_aa_filtered.fasta -out $OUTPUT/${SAMPLE_NAME}_aa_filtered_trimmed.fasta -gt 0.5
