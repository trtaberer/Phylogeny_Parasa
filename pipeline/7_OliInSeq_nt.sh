...
OUTPUT=/data/buscophy/results/OliInSeq/nt_filtered
mkdir -p $Output

# STEP 4:
# Run OliInSeq:
OliInSeq-v0.9.6 -i ${SAMPLE_DIRECTORY}/${SAMPLE_NAME}_nt.fasta -o $OUTPUT/${SAMPLE_NAME}_nt_filtered.fasta
